                ...
                <div className="divide-y-2 divide-zinc-300 dark:divide-zinc-950">
                    ...
                    <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
                        ...
                        <div className="flex gap-2 self-center">
                            <button type="button" className="w-8 h-8 rounded flex items-center justify-center transition-colors bg-zinc-400 hover:bg-zinc-500 dark:bg-zinc-800 dark:hover:bg-zinc-700">
                                <X className="w-3 h-3 text-zinc-50" /> 
                            </button>

                            <button type="button" className="w-8 h-8 rounded flex items-center justify-center transition-colors bg-violet-500 hover:bg-violet-600">
